  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="intersect:motion-preset-slide-up intersect:motion-opacity-in-0 intersect-half motion-ease-spring-smooth lg:col-span-2">
        ...
        <div className="intersect:motion-preset-slide-up intersect:motion-opacity-in-0 intersect-half intersect:motion-delay-[200ms] motion-ease-spring-smooth lg:col-span-3">
